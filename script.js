...
const workoutResponses = {
    ...
    recovery: "Recovery is when your muscles actually grow! Prioritize: sleep (7-9 hours), hydration, proper nutrition with protein, and active recovery days. Listen to your body to prevent injury! 😴",
    stretching: "Stretching improves flexibility and minimizes soreness. Do static (staying still) stretches after workouts (hold 20-30 seconds) and dynamic (moving) stretches before workouts.",

    // CARDIO
    cardio: "Cardio burns calories and builds stamina. Mix cardio (running, cycling) with high intensity workouts. Start with 20-30 minutes and gradually increase. 🏃",
    ...
    // STRENGTH
    strength: "Build strength with resistance training! Focus on compound movements (squats, deadlifts, bench press). Lift 3-4 times per week with a normal period of rest between sessions.",
    weights: "When lifting weights, prioritize form over weight! Start light, master the form, then gradually increase. Rest 48 hours between working the same muscle groups.",
    ...
    nutrition: "Nutrition fuels your workouts! Eat carbs like pasta and chicken for energy, protein for muscle repair, and healthy fats for hormones. Time meals 2-3 hours before intense exercise.",
    ...
    sleep: "Sleep is where growth happens! Aim for 7-9 hours per night. Good sleep improves recovery, mood, and performance. Keep a consistent sleep schedule to see the best results.",
    ...
    form: "Proper form prevents injuries and maximizes results! Watch tutorials, use mirrors, start light, and consider working with a trainer for total body exercises.",
    ...
    muscle: "To build muscle: progressive overload (gradually increase weight), protein intake (0.7-1g per body weight), and adequate rest (48 hrs between same muscle groups).",
    weight_loss: "To lose weight: combine strength training (builds metabolism) + cardio + nutrition (calorie deficit). Aim for 1-2 pounds per week. Be patient!",
